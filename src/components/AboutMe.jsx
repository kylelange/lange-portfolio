...
class AppComponent extends React.Component {
  ...
  render() {
    return (
      <div>
        <a name="aboutNav" className="hidden-about-nav"></a>
  ...
  {/*Hidden Contact info div until 50rem*/}
          ...
          <div className="aboutme-col2">
            ...
            <a href="https://www.linkedin.com/in/kyle-lange-dev/" ><img src="images/linkedin-logo.png" alt="a logo of my linkedIn account" className="aboutme-logo"></img></a>
          {/*href link not working*/}
            <a href="LangeResume_simple.pdf" download="LangeResume_simple.pdf"><img src="images/resume-logo.png" alt="a logo of my design: representing a resume" className="aboutme-logo"></img></a>
          </div>
        </div>
      </div>
    );
